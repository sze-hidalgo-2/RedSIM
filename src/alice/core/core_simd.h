...
force_inline function F32_X04  f32_x04_max                         (F32_X04 lhs, F32_X04 rhs)                         { return (F32_X04) { .simd = _mm_max_ps(lhs.simd, rhs.simd) }; }
force_inline function F32_X04  f32_x04_min                         (F32_X04 lhs, F32_X04 rhs)                         { return (F32_X04) { .simd = _mm_min_ps(lhs.simd, rhs.simd) }; }
